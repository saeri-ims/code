...
var southbb = JSON.parse(fs.readFileSync(data_path + 'SouthBB03_4326.geojson'));
...
// fs.writeFileSync(data_path+'sonarFootprint03.geojson',JSON.stringify(sonarFootprint));
